...
- **Трекинг прогресса** — поле `progress_updated` в frontmatter фиксирует дату последнего изменения прогресса чтения; обновляется только при реальном изменении значения.
